...
namespace SuperMario
{
    ...
    public class SmallMarioJumpingLeftSprite : IAnimatedSprite
    {
        ...
        public SmallMarioJumpingLeftSprite(Texture2D texture, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
        {

...
namespace SuperMario
{
    ...
    public class SmallMarioRightSprite : IAnimatedSprite
    {
        ...
        public SmallMarioRightSprite(Texture2D texture, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
        {

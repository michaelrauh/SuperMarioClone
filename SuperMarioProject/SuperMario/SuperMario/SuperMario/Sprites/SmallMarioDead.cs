...
namespace SuperMario
{
    public class SmallMarioDead
    {
        ...
        public class SmallMarioDead : IAnimatedSprite
        {
            ...
            public IAnimatedSprite SmallMarioDead(Texture2D texture, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns, int xRes, int yRes)
            {

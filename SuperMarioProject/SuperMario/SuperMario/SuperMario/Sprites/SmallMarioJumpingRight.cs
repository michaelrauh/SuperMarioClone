...
{
    public class SmallMarioJumpingRight
    {
        ...
        public class SmallMarioJumpingRight : IAnimatedSprite
        {
            ...
            public IAnimatedSprite SmallMarioJumpingRight(Texture2D texture, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns, int xRes, int yRes)
            {

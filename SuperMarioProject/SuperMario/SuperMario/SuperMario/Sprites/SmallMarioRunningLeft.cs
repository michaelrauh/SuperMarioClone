...
{
    public class SmallMarioRunningLeft
    {
        ...
        public class SmallMarioRunningLeft : IAnimatedSprite
        {
            ...
            public IAnimatedSprite SmallMarioRunningLeft(Texture2D texture, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns, int xRes, int yRes)
            {

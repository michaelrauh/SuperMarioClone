...
namespace SuperMario
{
    public class SmallMarioLeft
    {
        ...
        public class SmallMarioLeft : IAnimatedSprite
        {
            ...
            public IAnimatedSprite SmallMarioLeft(Texture2D texture, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns, int xRes, int yRes)
            {

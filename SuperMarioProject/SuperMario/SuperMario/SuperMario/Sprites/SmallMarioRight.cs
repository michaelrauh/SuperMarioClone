...
namespace SuperMario
{
    public class SmallMarioRight
    {
        ...
        public class SmallMarioRight : IAnimatedSprite
        {
            ...
            public IAnimatedSprite SmallMarioRight(Texture2D texture, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns, int xRes, int yRes)
            {

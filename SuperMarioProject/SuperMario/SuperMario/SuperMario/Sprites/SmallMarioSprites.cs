using IAnimatedSprite;

namespace SuperMario
{
    public class SmallMarioSprites
    {
        ...
        public class SmallMarioRunningRight : IAnimatedSprite
        {
            ...
            public IAnimatedSprite SmallMarioRunningRight(Texture2D texture, SpriteBatch spriteBatch, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
            {
            ...
            public void Draw(Vector2D location)
            {
        ...
        public class SmallMarioRunningLeft : IAnimatedSprite
        {
            public Texture2D Texture { get; set; }
            public int Rows { get; set; }
            public int Columns { get; set; }
            ...
            public IAnimatedSprite SmallMarioRunningLeft(Texture2D texture, SpriteBatch spriteBatch, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
            {
                this.Texture = texture;
                this.totalFrames = endFrameCoordinate - startFrameCoordinate; // rows*columns==total number of frames in sprite atlas including empties
                this.Rows = rows;
        ...
        public class SmallMarioRight : IAnimatedSprite
        {
            public Texture2D Texture { get; set; }
            public int Rows { get; set; }
            public int Columns { get; set; }
            ...
            public IAnimatedSprite SmallMarioRight(Texture2D texture, SpriteBatch spriteBatch, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
            {
                this.Texture = texture;
                this.totalFrames = endFrameCoordinate - startFrameCoordinate; // rows*columns==total number of frames in sprite atlas including empties
                this.Rows = rows;
        ...
        public class SmallMarioLeft : IAnimatedSprite
        {
            public Texture2D Texture { get; set; }
            public int Rows { get; set; }
            public int Columns { get; set; }
            ...
            public IAnimatedSprite SmallMarioLeft(Texture2D texture, SpriteBatch spriteBatch, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
            {
                this.Texture = texture;
                this.totalFrames = endFrameCoordinate - startFrameCoordinate; // rows*columns==total number of frames in sprite atlas including empties
                this.Rows = rows;
        ...
        public class SmallMarioJumpingRight : IAnimatedSprite
        {
            public Texture2D Texture { get; set; }
            public int Rows { get; set; }
            public int Columns { get; set; }
            ...
            public IAnimatedSprite SmallMarioJumpingRight(Texture2D texture, SpriteBatch spriteBatch, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
            {
                this.Texture = texture;
                this.totalFrames = endFrameCoordinate - startFrameCoordinate; // rows*columns==total number of frames in sprite atlas including empties
                this.Rows = rows;
        ...
        public class SmallMarioJumpingLeft : IAnimatedSprite
        {
            ...
            public IAnimatedSprite SmallMarioJumpingLeft(Texture2D texture, SpriteBatch spriteBatch, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
            {
                this.Texture = texture;
                this.totalFrames = endFrameCoordinate - startFrameCoordinate; // rows*columns==total number of frames in sprite atlas including empties
                this.Rows = rows;
        ...
        public class SmallMarioDead : IAnimatedSprite
        {
            public Texture2D Texture { get; set; }
            public int Rows { get; set; }
            public int Columns { get; set; }
            ...
            public IAnimatedSprite SmallMarioDead(Texture2D texture, SpriteBatch spriteBatch, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
            {
                this.Texture = texture;
                this.totalFrames = endFrameCoordinate - startFrameCoordinate; // rows*columns==total number of frames in sprite atlas including empties
                this.Rows = rows;

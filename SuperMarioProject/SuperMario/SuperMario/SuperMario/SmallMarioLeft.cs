...
namespace SuperMario
{
    ...
    public class SmallMarioLeftSprite : IAnimatedSprite
    {
        ...
        public SmallMarioLeftSprite(Texture2D texture, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
        {

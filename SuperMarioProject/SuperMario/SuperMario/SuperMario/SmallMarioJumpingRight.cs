...
namespace SuperMario
{
    ...
    public class SmallMarioJumpingRightSprite : IAnimatedSprite
    {
        ...
        public SmallMarioJumpingRightSprite(Texture2D texture, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
        {

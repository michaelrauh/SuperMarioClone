...
namespace SuperMario
{
    ...
    public class SmallMarioRunningLeftSprite : IAnimatedSprite
    {
        ...
        public SmallMarioRunningLeftSprite(Texture2D texture, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
        {

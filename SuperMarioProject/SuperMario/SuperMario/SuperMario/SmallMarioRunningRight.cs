...
namespace SuperMario
{
    ...
    class SmallMarioRunningRightSprite : IAnimatedSprite
    {
        ...
        public SmallMarioRunningRightSprite(Texture2D texture, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
        {

...
namespace SuperMario
{
    ...
    public class SmallMarioDeadSprite : IAnimatedSprite
    {
        ...
        public SmallMarioDeadSprite(Texture2D texture, int startFrameCoordinate, int endFrameCoordinate, int rows, int columns)
        {

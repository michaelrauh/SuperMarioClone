...
namespace SuperMario.Enemies
{
    public class Koopa : IEnemy
    {
        ...
        public Koopa(Vector2 initialLocation)
        {
            currentLocation = initialLocation;
            CurrentState = new EnemyStates.KoopaMovingLeftState(this);
            IsDead = false;
            yVelocity = 3;
        ...
        public void Update(GameTime gameTime, Camera camera)
        {
            ...
            DestinationRectangle = new Rectangle((int)(currentLocation.X - camera.Position.X), (int)(currentLocation.Y), CurrentState.Sprite.Width, CurrentState.Sprite.Height);
        }
